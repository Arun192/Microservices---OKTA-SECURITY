package org.arun.orderservice;

import java.util.Arrays;

import org.arun.orderservice.external.intercept.RestTemplateIntercepter;
...
@ComponentScan({"org.arun.orderservice" , "org.arun.ProductService.model"})
@EnableFeignClients
...
public class OrderServiceApplication {
	...
	public RestTemplate restTemplate() {
		...
		restTemplate.setInterceptors(
				Arrays.asList(new RestTemplateIntercepter(
